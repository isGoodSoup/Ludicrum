...
public enum Achievements {
    FIRST_CAPTURE           (1001L, "a01_first_steps",            "First Steps",            "Capture your first\n chess piece"),
    SECRET_TOGGLE           (1002L, "a02_toggles",                "The One To Rule 'Em All","My precious, my dear precious..."),
    CHECKMATE               (1003L, "a03_checkmate",              "Checkmate!",             "Win a game of chess\n by checkmate"),
    ...
    CHECK_OVER              (1007L, "a07_check_over",             "It's Check And Over",    "Check 4 times in the\n same game"),
    HEAVY_CROWN             (1008L, "a08_heavy_crown",            "Heavy Is The Crown",     "Win 128 games"),
    ALL_PIECES              (1009L, "a09_good_riddance",          "And Good Riddance",      "Clear all pieces from\n the board"),
    HARD_GAME               (1010L, "a10_that_was_easy",          "That Was Easy!",         "Win a hard chess game"),
    UNTOUCHABLE             (1011L, "a11_cant_touch_this",        "Can't Touch This",       "Win a game without\n getting checked"),
    MASTER_OF_NONE          (1012L, "a12_master_of_none",         "Master of None",         "Complete all Chess\n achievements"),

    ROUND_CAPTURE           (2001L, "a13_first_capture",          "Wait A Second",          "Capture your first\n checkers piece"),
    ...
    CLEAN_SWEEP             (2010L, "a22_lord_of_checkers",       "The Lord Of Checkers",   "Capture all opponent\n pieces"),
    STALEMATE_SURVIVOR      (2011L, "a23_stalemate_survivor",     "The Last Of Us",         "Win with a single piece"),
    CHAMPION                (2012L, "a24_kingmaker",              "Kingmaker",              "Complete all Checkers\n achievements"),
