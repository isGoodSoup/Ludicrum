...
public enum Achievements {
    ...
    ROUND_CAPTURE           (2001L, "a13_first_capture",          "First Capture",          "Capture your first checkers piece"),
    QUICK_START             (2002L, "a14_quick_start",            "Quick Start",            "Win a checkers game in under 8 moves"),
    STRATEGIST              (2003L, "a15_strategist",             "Plastique Strategist",   "Win a checkers game without losing a single piece"),
    DOUBLE_JUMP             (2004L, "a16_double_jump",            "Double Jump",            "Perform a double jump in one turn"),
    TRIPLE_THREAT           (2005L, "a17_triple_threat",          "Triple Threat",          "Perform a triple jump in one turn"),
    KING_ME                 (2006L, "a18_king_me",                "King Me",                "Promote your first piece to a King"),
    KINGDOM_BUILDER         (2007L, "a19_kingdom_builder",        "Kingdom Come",           "Promote 3 pieces to Kings in a single game"),
    COMEBACK                (2008L, "a20_comeback",               "Comeback",               "Win a game after being down by 3 or more pieces"),
    DRAW_MASTER             (2009L, "a21_draw_master",            "Draw Master",            "End a game in a draw"),
    CLEAN_SWEEP             (2010L, "a22_clean_sweep",            "Clean Sweep",            "Win a game by capturing all opponent pieces"),
    STALEMATE_SURVIVOR      (2011L, "a23_stalemate_survivor",     "Last Of Us",             "Avoid losing when only 1 piece remains"),
    CHAMPION                (2012L, "a24_checkers_champion",      "Checkers Champion",      "Complete all Checkers achievements"),
