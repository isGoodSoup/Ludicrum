...
public class Colors {
    ...
    public static final List<Color[]> THEMES_LIST = List.of(
            new Color[]{DEFAULT_BACKGROUND, DEFAULT_FOREGROUND, DEFAULT_EDGE},
            new Color[]{BLACK_BACKGROUND, WHITE_FOREGROUND, BLACK_EDGE},
            new Color[]{OCEAN_BACKGROUND, OCEAN_FOREGROUND, OCEAN_EDGE},
            new Color[]{FOREST_BACKGROUND, FOREST_FOREGROUND, FOREST_EDGE},
            new Color[]{FAIRY_BACKGROUND, FAIRY_FOREGROUND, FAIRY_EDGE}
    );
